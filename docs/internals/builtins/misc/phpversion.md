...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:542](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L542) (`lower_phpversion`)
