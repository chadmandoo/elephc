...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1393](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1393) (`lower_is_iterable`)
