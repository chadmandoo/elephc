...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1411](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1411) (`lower_is_iterable`)
