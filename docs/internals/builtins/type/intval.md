...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1135](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1135) (`lower_intval`)
