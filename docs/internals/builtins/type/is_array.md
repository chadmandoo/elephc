...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1629](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1629) (`lower_is_array`)
