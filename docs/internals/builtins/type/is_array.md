...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1620](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1620) (`lower_is_array`)
