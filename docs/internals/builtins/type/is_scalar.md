...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1660](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1660) (`lower_is_scalar`)
