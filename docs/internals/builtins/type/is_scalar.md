...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1651](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1651) (`lower_is_scalar`)
