...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1644](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1644) (`lower_is_object`)
