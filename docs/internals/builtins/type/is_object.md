...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1635](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1635) (`lower_is_object`)
