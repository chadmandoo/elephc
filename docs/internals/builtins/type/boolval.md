...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1193](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1193) (`lower_boolval`)
