...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1619](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1619) (`lower_is_null_builtin`)
