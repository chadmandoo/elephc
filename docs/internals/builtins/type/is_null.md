...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1610](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1610) (`lower_is_null_builtin`)
