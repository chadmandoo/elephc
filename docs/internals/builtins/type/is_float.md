...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1362](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1362) (`lower_static_type_predicate`)
