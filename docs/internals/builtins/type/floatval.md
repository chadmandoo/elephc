...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1159](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1159) (`lower_floatval`)
