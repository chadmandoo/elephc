...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:1353](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L1353) (`lower_static_type_predicate`)
