...
- **Lowering**: [`src/codegen/lower_inst/builtins.rs`:567](https://github.com/illegalstudio/elephc/blob/main/src/codegen/lower_inst/builtins.rs#L567) (`lower_function_exists`)
