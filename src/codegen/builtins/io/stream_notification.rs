...
//!
//! Called from:
//! - `crate::codegen::builtins::io::stream_context_create::emit()`.
//! - `crate::codegen::builtins::io::stream_context_set_params::emit()`.
//!
//! Key details:
...
use crate::codegen::callable_descriptor::emit_retain_current_descriptor;
