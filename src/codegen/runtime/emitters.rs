...
pub(crate) fn emit_runtime(emitter: &mut Emitter, features: RuntimeFeatures) {
    ...
    strings::emit_str_spaceship(emitter);
    arrays::emit_array_spaceship(emitter);
    ...
    exceptions::emit_throwable_methods(emitter);
    ...
    objects::emit_class_has_constructor_by_name(emitter);
    objects::emit_class_parent_name_by_name(emitter);
