...
fn emit_throw_exception_aarch64(
    ...
    emitter.instruction("mov x0, #40");                                         // request Throwable payload storage
    ...
    emitter.instruction("str xzr, [x0, #32]");                                  // previous throwable defaults to null
...
fn emit_throw_exception_x86_64(
    ...
    emitter.instruction("mov rax, 40");                                         // request Throwable payload storage
    ...
    emitter.instruction("mov QWORD PTR [rax + 32], 0");                         // previous throwable defaults to null
