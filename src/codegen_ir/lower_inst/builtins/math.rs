...
fn emit_throw_value_error_aarch64(
    ...
    ctx.emitter.instruction("mov x0, #40");                                     // request Throwable payload storage for the clamp ValueError
...
fn emit_throw_value_error_x86_64(
    ...
    ctx.emitter.instruction("mov rax, 40");                                     // request Throwable payload storage for the clamp ValueError
